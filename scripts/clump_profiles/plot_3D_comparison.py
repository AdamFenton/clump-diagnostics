...
def apply_filter(array):
    ...
    smoothed_array = savgol_filter(array,2,1)
...
ax_main[1,1].plot(bins,avg_infall_z_pos,c='blue',label='+z direction')
...
ax_main[1,1].plot(bins,avg_infall_z_neg,c='blue',linestyle='--',label='-z direction')
